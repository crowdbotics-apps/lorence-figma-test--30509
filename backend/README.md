...
## Project Structure
    ...
    ├── lorence_figma_test__30509  # Django project configurations
...
1. Clone this repo and `cd lorence_figma_test__30509`
...
2. Clone this repo and `cd lorence_figma_test__30509`
